...
O que está aqui **não vem ativo** no Contex OS. São skills que atendem um caso de uso
...
O fluxo normal do Contex OS não precisa de nada daqui. Nada mesmo.
...
**Ela não funciona como está.** Depende de dois scripts que o Contex OS **não** inclui:
