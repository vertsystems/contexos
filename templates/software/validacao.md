...
- **Modelo de negócio de aplicativo com milhões de usuários** (rede de dois lados, subsídio de um lado pelo outro, receita por escala de audiência). O comprador do Contex OS vende para dezenas ou centenas de clientes
