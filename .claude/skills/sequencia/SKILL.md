...
- **Lembrete de horário é outra skill.** O que existe pra derrubar a taxa de falta é `/confirmacao-de-agenda`, que mede a taxa, escreve a política de cancelamento e a regra de sinal, e volta pra cá quando o pedido é só a série de mensagens
